...
************** Usage **************
Use global chat to send commands. if global chat is not available. use Group chat

example:
!kpl name 
 * kicks the player with reason defined in Commands.xml
!kpl name !r New reasoon
 * kicks the player with new custom reason

!bpl name ->bans player. !r New reason can also be used here.
!cm mname ->change mission. 
++ many more
Commands are defined in your commands.xml file.
...
Auto lock server when N players are in the lobby. 
