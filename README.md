...
** NOTE **: Настоятельно рекомендуется отключить UAC при установке части, особенно, Perl части установки. Щелчок правой кнопкой мыши и работает как администрация ** не работает должным образом *** из-за способа, что Perl приложение настройки работает.
