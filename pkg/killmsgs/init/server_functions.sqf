...
fnc_playerHit   = compile preprocessFileLineNumbers "\z\addons\dayz_server\compile\fnc_playerHit.sqf";
fnc_playerDeath = compile preprocessFileLineNumbers "\z\addons\dayz_server\compile\fnc_playerDeath.sqf";
