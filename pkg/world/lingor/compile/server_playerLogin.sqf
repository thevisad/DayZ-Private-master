...
if (!(_model in ["SurvivorW2_DZ","Survivor2_DZ","Survivor3_DZ","Sniper1_DZ","Soldier1_DZ","Camo1_DZ","Bandit1_DZ","Rocket_DZ","pzn_dz_Contractor1_BAF","pzn_dz_Contractor2_BAF","pzn_dz_Contractor3_BAF","BanditW1_DZ"])) then {
	_model = "Survivor2_DZ";
};
