...
if (!_isNew) then {
	...
	if (!(_model in ["BW1_DZ", "Civilian2_DZ","Civilian3_DZ","Civilian4_DZ","Civilian5_DZ","police1_DZ","police2_DZ","Hero1_DZ","SurvivorW2_DZ","Survivor2_DZ","Sniper1_DZ","Soldier1_DZ","Camo1_DZ","BanditW1_DZ","Bandit1_DZ","SurvivorW2_DZ"])) then {
		_model = "Civilian2_DZ";
	};
